...
public class ArchivistModuleTest {
    ...
    @Test
    public void testProvideTemporaryFolder(
        ...
        module.provideTemporaryFolder(fileSystemManagerProvider);
        // TODO: verify something.
    }
    ...
    @Test
    public void testProvideFileSystemManager() throws Exception {
        module.provideFileSystemManager();
        // TODO: verify something.
    }
}
